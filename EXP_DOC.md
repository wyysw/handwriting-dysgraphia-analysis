...
```
python features/maze_geometry.py --mask data/shape_out/maze_mask.png --vis data/feature/maze/_vis_geometry.png
```
...
4. **乱画样本不参与归一化的拟合，不进入最终的特征矩阵**——在阶段6被赋予 prob=1.0。
